...
import ink.zfei.gen.Generator.GeneratorModel;
...
import ink.zfei.gen.provider.java.model.JavaClass;
import ink.zfei.gen.util.BeanHelper;
import ink.zfei.gen.util.GLogger;
import ink.zfei.gen.util.GeneratorException;
import ink.zfei.gen.util.typemapping.DatabaseTypeUtils;
...
public class GeneratorFacade {
    ...
    public GeneratorFacade(String path) {

        g.setOutRootDir(path);
    }
