package ink.zfei.gen.provider.db.table.model;


import ink.zfei.gen.GeneratorProperties;
import ink.zfei.gen.provider.db.table.model.ForeignKey.ReferenceKey;
import ink.zfei.gen.provider.db.table.model.util.ColumnHelper;
import ink.zfei.gen.util.GLogger;
import ink.zfei.gen.util.StringHelper;
import ink.zfei.gen.util.TestDataGenerator;
import ink.zfei.gen.util.typemapping.ActionScriptDataTypesUtils;
import ink.zfei.gen.util.typemapping.DatabaseDataTypesUtils;
import ink.zfei.gen.util.typemapping.JavaPrimitiveTypeMapping;
