package ink.zfei.gen.provider.db.sql;


import ink.zfei.gen.provider.db.sql.model.Sql;
import ink.zfei.gen.provider.db.sql.model.SqlParameter;
import ink.zfei.gen.provider.db.table.TableFactory;
import ink.zfei.gen.provider.db.table.TableFactory.NotFoundTableException;
import ink.zfei.gen.provider.db.table.model.Column;
import ink.zfei.gen.provider.db.table.model.Table;
import ink.zfei.gen.util.BeanHelper;
import ink.zfei.gen.util.GLogger;
import ink.zfei.gen.util.StringHelper;
import ink.zfei.gen.util.sqlparse.NamedParameterUtils;
import ink.zfei.gen.util.sqlparse.ParsedSql;
import ink.zfei.gen.util.sqlparse.ResultSetMetaDataHolder;
import ink.zfei.gen.util.sqlparse.SqlParseHelper;
import ink.zfei.gen.util.typemapping.JdbcType;
